...
def main():
    ...
    img_dir_path = current_dir + '/data/test_set/images'
    txt_dir_path = current_dir + '/data/test_set/texts'
    ...
    from img_cap_loader import load_normalized_img_and_text

    image_label_pairs = load_normalized_img_and_text(img_dir_path, txt_dir_path, img_width=img_width, img_height=img_height)
