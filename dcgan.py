        ...
        for epoch in range(epochs):
            ...
            for batch_index in range(batch_count):
                ...
                if (epoch * batch_size + batch_index) % 10 == 9:
                    ...
                    self.write_log(callback, train_names, d_loss, batch_index)
                """
            ...
            if epoch % 10 == 0 and epoch != 0:
                print("EPOCHHHHH  "+ str(epoch))
            self.logs['d_loss'].append(d_loss_temp/4)
            self.logs['g_loss'].append(g_loss_temp/4)
